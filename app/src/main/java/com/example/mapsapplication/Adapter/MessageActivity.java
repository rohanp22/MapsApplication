...
import com.example.mapsapplication.Profile2;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fuser = SharedPrefManager.getInstance(MessageActivity.this).getUser();
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    sendMessage(fuser.getId()+"", userid, msg);
                } else {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                readMesagges(fuser.getId()+"", userid, user.getImageURL());
            }
    ...
    private void seenMessage(final String userid){
        reference = FirebaseDatabase.getInstance().getReference("Chats").child(fuser.getId()+"");
        seenListener = reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    Chat chat = snapshot.getValue(Chat.class);
                    if (chat.getReceiver().equals(fuser.getId()+"") && chat.getSender().equals(userid)){
    ...
    private void sendMessage(String sender, final String receiver, String message){
        ...
        reference.child("Chats").child(fuser.getId()+"").push().setValue(hashMap);
        ...
        final DatabaseReference chatRefReceiver = FirebaseDatabase.getInstance().getReference("Chatlist")
                .child(userid)
                .child(fuser.getId()+"");
        chatRefReceiver.child("id").setValue(fuser.getId()+"");
        chatRefReceiver.child("time").setValue(System.currentTimeMillis() + "");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getId()+"", R.mipmap.ic_launcher, username+": "+message, "New Message",
                            userid);
    ...
    public void gotoprofile(View view) {
        ...
        Profile2 profileFragment = new Profile2();
